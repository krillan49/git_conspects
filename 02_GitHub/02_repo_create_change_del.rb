...
# Решение работает, если удаляемый коммит является последним:
...
# Удалите последний коммит, сохранив проделанную вами работу:
# $ git reset --soft HEAD~1
# Удалите последний коммит, уничтожив всю проделанную вами работу:
# $ git reset --hard HEAD~1
# Отправьте изменения в удаленный репозиторий (-f или --force):
# $ git push -f
