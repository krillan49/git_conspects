...
# $ git checkout main                          - Переключиться на main (или develop)
...
# $ git merge main                            - подтянуть последние изменения
# б) Или:
# $ git rebase main                           - аккуратно переписать историю (если умеешь)
